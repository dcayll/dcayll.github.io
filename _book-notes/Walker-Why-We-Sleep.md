...
- Brain signals when awake are asynchronous ~30-40 Hz
  - Because brain is working fast to keep up with sensory input
...
- Somnambulism - sleepwalking
  - Between NREM deep sleep and wakefullness
...
- Insomnia - not being able to sleep when given ample opprotunity to sleep
  ...
  - Triggered by psychological factors- emotional concerns or emotional distress/anxiety causes more triggered sympathetic nervous system:
    - Raised metabolic rate -> higher body temp -> bad for sleep
    - Raised cortisol, adrenaline and noradrenaline also
    - Altered brain activity
      - Insomnia people have higher activity in emotional center (amygdlya) and memory retrospection (hippocampus)
    - Lower quality of sleep when it does come

- Narcolepsy - 3 major symptoms: from a mutation, not genetically heritable
  1. Excessive daytime sleepiness - equivalent to feeling of 3-4 days without sleep
  2. Sleep paralysis - typically during REM
  3. Cataplexy - sudden, unexpected loss in muscle control during strong emotions, positive or negative, without loss of consciousness
     - From abnormal REM-sleep circuitry
  - A "sleep-wake" switch in the hypathalamus that turns body off via brain stem is faulty in those with narclepsy
    - When awake, not truely awake, when asleep, never good sleep
    - Orexin is the hormone that regulates this sleep/wake switch and is very deficient in narcolepsy patients

- Fatal familial insomnia (FFI) - fast onset insomnia, no sleep until you die from it
  - Looks like dimensia symptom-wise. Can kill in ~10 months
  - From a misformed prion protein - attacks thalamus
    - Thalamus switches off sensory gate to allow sleep
